        ...
        <div class="row">
            ...
            <div class="col-md-7 mt-2">
                <div class="d-inline-flex">
                    ...
                    <div class="container mt-3">
                        <h5 class="w-100 favorite-item-text">{{ App\Models\Product::find($fav->favoriteable_id)->name }}</h5>
                        <h6 class="w-100 favorite-item-text">&yen;{{ App\Models\Product::find($fav->favoriteable_id)->price }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('products.favorite', $fav->favoriteable_id) }}" class="favorite-item-delete">
                    削除
                </a>
            </div>
            <div class="col-md-3 d-flex align-items-center justify-content-end">
                <form method="POST" action="{{ route('carts.store') }}" class="m-3 align-items-end">
                    ...
                    <button type="submit" class="btn favorite-add-cart">カートに入れる</button>
                </form>
            </div>
            @endforeach
        </div>
