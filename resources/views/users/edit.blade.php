            ...
            <form method="POST" action="{{ route('mypage') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show editUserName">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus placeholder="甘井 甘太郎">
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show editUserName">
                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" autofocus placeholder="example@sample.com">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="postal_code" class="text-md-left edit-user-info-label">郵便番号</label>
                    </div>
                    <div class="collapse show editUserName">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="address" class="text-md-left edit-user-info-label">住所</label>
                    </div>
                    <div class="collapse show editUserName">
                        <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $user->address }}" required autocomplete="address" autofocus placeholder="福島県福島市X-X-X">
                        @error('address')
                        <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between">
                        <label for="phone" class="text-md-left edit-user-info-label">電話番号</label>
                    </div>
                    <div class="collapse show editUserName">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn delete-submit-button">退会する</button>
                                </div>
                            </div>
                        </div>
                    </div>
